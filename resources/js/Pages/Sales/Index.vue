<template>
    <AppLayout title="Mercat de Motos">
        <div class="px-4 py-6 pb-24 max-w-7xl mx-auto">
            ...
            <Link :href="route('sales.mine')" class="w-full mb-6 bg-brand-surface border border-brand-neon/30 text-white py-3 rounded-xl flex items-center justify-between px-4 hover:bg-brand-neon/10 transition group shadow-lg">
