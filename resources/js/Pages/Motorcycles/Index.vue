    ...
    <AppLayout>
        <div class="px-4 py-6"> 
            ...
            <div v-if="showFilters && motos.length > 0" class="bg-brand-black border border-brand-dark rounded-xl p-4 mb-6 shadow-inner space-y-4 animate-fade-in">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div>
                        ...
                        <input v-model="filters.search" type="text" placeholder="Marca, model o matrícula..." class="w-full bg-brand-surface border-brand-dark rounded-lg text-white text-sm focus:border-brand-neon mt-1">
                    </div>
                    <div>
                        <label class="text-xs text-gray-500 uppercase font-bold">Estil</label>
                        <select v-model="filters.type" class="w-full bg-brand-surface border-brand-dark rounded-lg text-white text-sm focus:border-brand-neon mt-1">
                            ...
                            <option value="Classic">Clàssica</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-3 gap-3">
                    <div>
                        <label class="text-xs text-gray-500 uppercase font-bold">Any Mín</label>
                    ...
                    <div>
                        <label class="text-xs text-gray-500 uppercase font-bold">Any Màx</label>
                    ...
                    <div>
                        <label class="text-xs text-gray-500 uppercase font-bold">KM Màx</label>
                ...
                <div class="border-t border-brand-dark pt-3 mt-2">
                    ...
                    <div class="flex gap-2">
                        <select v-model="filters.sortBy" class="flex-1 bg-brand-surface border-brand-dark rounded-lg text-white text-sm focus:border-brand-neon">
                            <option value="brand">Marca i Model</option>
            ...
            <div v-else-if="filteredMotos.length === 0" class="flex flex-col items-center justify-center py-12 text-center opacity-60 bg-brand-surface rounded-xl border border-brand-dark border-dashed">
                <p class="text-gray-400 font-medium">No s'ha trobat cap moto amb aquests filtres.</p>
