    ...
    <AppLayout :current-moto-id="motorcycle.id">
        <div class="px-4 py-6 pb-24">
            <div class="flex items-center justify-between mb-6">
                <div>
                    <Link :href="route('dashboard', motorcycle.id)" class="text-gray-400 text-sm hover:text-white flex items-center gap-1">{{ $t('upgrades.back') }}</Link>
                    <h1 class="text-2xl font-bold text-purple-400 mt-1">{{ $t('upgrades.title') }}</h1>
