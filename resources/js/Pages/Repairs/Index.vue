        ...
        <div v-if="showCreateModal" class="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div class="relative bg-brand-surface border border-red-900 rounded-xl p-6 w-full max-w-sm shadow-lg">
                ...
                <form @submit.prevent="submitCreate">
                    <div class="space-y-4">
                        <div>
                            <label class="text-gray-400 text-sm">Què s'ha trencat?</label>
                        ...
                        <div>
                            <label class="text-gray-400 text-sm">Detalls</label>
            ...
            <div class="relative bg-brand-surface border border-red-500 rounded-xl p-6 w-full max-w-sm shadow-lg">
                ...
                <form @submit.prevent="submitComplete">
                    <div class="space-y-4">
                        ...
                        <div><label class="text-gray-400 text-sm">KM Actuals</label><input v-model="completeForm.km_at_moment" type="number" class="w-full bg-brand-black border-brand-dark rounded text-white focus:border-red-500" required></div>
