            ...
            <div v-show="!isMapOpen">
                ...
                <div class="flex items-center justify-between mb-8">
                    <div class="flex items-center gap-3">
                        <button type="button" onclick="window.history.length > 1 ? window.history.back() : window.location.href='/my-routes'" class="w-10 h-10 rounded-full bg-brand-neon flex items-center justify-center text-black hover:bg-white transition flex-shrink-0 shadow-[0_0_15px_rgba(12,225,181,0.3)]">
...
const submit = () => {
    ...
    // Ens assegurem que geo_json s'envia com a string per no petar el max_input_vars del PHP!
    form.transform(data => ({ 
            ...data, 
