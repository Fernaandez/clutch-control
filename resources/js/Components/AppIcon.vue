...
const ICONS = {
    ...
    moto: '<path stroke-linecap="round" stroke-linejoin="round" d="M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z" />',
    infinity: '<path stroke-linecap="round" stroke-linejoin="round" d="M5.25 12c0-2.071 1.679-3.75 3.75-3.75 1.243 0 2.343.604 3.025 1.534M9 8.25c1.243 0 2.343.604 3.025 1.534m0 0a3.75 3.75 0 1 0 0 4.432m0-4.432A3.74 3.74 0 0 1 15 8.25c2.071 0 3.75 1.679 3.75 3.75s-1.679 3.75-3.75 3.75c-1.243 0-2.343-.604-3.025-1.534" />',
    ...
    finish: '<path stroke-linecap="round" stroke-linejoin="round" d="M3 3v1.5M3 21v-6m0 0 2.77-.693a9 9 0 0 1 6.208.682l.108.054a9 9 0 0 0 6.086.71l3.114-.732a48.524 48.524 0 0 1-.005-10.499l-3.11.732a9 9 0 0 1-6.085-.711l-.108-.054a9 9 0 0 0-6.208-.682L3 4.5M3 15V4.5" />',
    crown: '<path stroke-linecap="round" stroke-linejoin="round" d="M3 7.5 7 12l5-7 5 7 4-4.5v9.75A2.25 2.25 0 0 1 18.75 19.5H5.25A2.25 2.25 0 0 1 3 17.25V7.5Z" /><path stroke-linecap="round" stroke-linejoin="round" d="M3 17.25h18" />',
