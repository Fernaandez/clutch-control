    ...
    <div class="min-h-screen bg-gray-100 flex font-sans">
        ...
        <aside class="w-64 bg-gray-900 text-white flex flex-col shrink-0">
            <div class="h-16 flex items-center justify-center border-b border-gray-800">
                <img :src="appLogo" alt="Clutch Admin Logo" class="h-8 w-auto">
            </div>
            <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
                <Link :href="route('admin.dashboard')" class="block px-4 py-3 rounded transition-colors hover:bg-gray-800" :class="{'bg-gray-800 border-l-4 border-blue-500': route().current('admin.dashboard')}">
                    <div class="flex items-center space-x-3">
                        <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z"></path></svg>
                        <span>Dashboard</span>
                    </div>
                </Link>
                ...
                <Link :href="route('admin.users.index')" class="block px-4 py-3 rounded transition-colors hover:bg-gray-800" :class="{'bg-gray-800 border-l-4 border-blue-500': route().current('admin.users.*')}">
                    <div class="flex items-center space-x-3">
                ...
                <Link :href="route('admin.routes.index')" class="block px-4 py-3 rounded transition-colors hover:bg-gray-800" :class="{'bg-gray-800 border-l-4 border-blue-500': route().current('admin.routes.*')}">
                    <div class="flex items-center space-x-3">
                ...
                <Link :href="route('admin.events.index')" class="block px-4 py-3 rounded transition-colors hover:bg-gray-800" :class="{'bg-gray-800 border-l-4 border-blue-500': route().current('admin.events.*')}">
                    <div class="flex items-center space-x-3">
                ...
                <Link :href="route('admin.sales.index')" class="block px-4 py-3 rounded transition-colors hover:bg-gray-800" :class="{'bg-gray-800 border-l-4 border-blue-500': route().current('admin.sales.*')}">
                    <div class="flex items-center space-x-3">
                ...
                <Link :href="route('admin.motorcycles.index')" class="block px-4 py-3 rounded transition-colors hover:bg-gray-800" :class="{'bg-gray-800 border-l-4 border-blue-500': route().current('admin.motorcycles.*')}">
                    <div class="flex items-center space-x-3">
                ...
                <Link :href="route('admin.maintenance.index')" class="block px-4 py-3 rounded transition-colors hover:bg-gray-800" :class="{'bg-gray-800 border-l-4 border-blue-500': route().current('admin.maintenance.*')}">
                    <div class="flex items-center space-x-3">
        ...
        <main class="flex-1 flex flex-col h-screen overflow-hidden bg-gray-50">
            ...
            <header class="h-16 bg-white shadow-sm flex items-center justify-between px-8 z-10 border-b border-gray-200">
                ...
                <div class="flex items-center space-x-4">
                    <span class="text-sm font-medium text-gray-600 bg-gray-100 px-3 py-1 rounded-full border border-gray-200">Admin Mode</span>
                    <span class="text-sm font-semibold text-gray-800">{{ $page.props.auth.user.name }}</span>
                </div>
            </header>
