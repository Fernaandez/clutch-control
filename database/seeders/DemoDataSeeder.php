    ...
    public function run(): void
    {
        ...
        $eventsData = [
            [
                ...
                'start_time' => now()->addDays(7)->setHour(9)->setMinute(0),
                'end_time' => now()->addDays(7)->setHour(14)->setMinute(0),
            ...
            [
                ...
                'start_time' => now()->addDays(14)->setHour(7)->setMinute(0),
                'end_time' => now()->addDays(14)->setHour(18)->setMinute(0),
            ...
            [
                ...
                'start_time' => now()->addDays(21)->setHour(10)->setMinute(0),
                'end_time' => now()->addDays(21)->setHour(22)->setMinute(0),
            ...
            [
                ...
                'start_time' => now()->addDays(5)->setHour(8)->setMinute(30),
                'end_time' => now()->addDays(5)->setHour(13)->setMinute(0),
